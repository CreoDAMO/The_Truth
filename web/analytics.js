                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="glass rounded-xl p-6 mb-8">
                            <h3 className="text-xl font-semibold mb-6">Philosophy Performance Metrics</h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <h4 className="text-lg font-semibold text-yellow-400 mb-3">Truth Validation</h4>
                                ...
                                <div>
                                    <h4 className="text-lg font-semibold text-green-400 mb-3">Economic Impact</h4>
                                    <div className="space-y-2 text-sm">
                                        <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-between">
                                            <span>Royalty Revenue:</span>
                                            <span className="text-purple-400">{formatCurrency(analyticsData.secondaryMarket.volume * 0.1)}</span>
                                        </div>
                                    </div>
                                </div>
                                
                                <div>
                                    <h4 className="text-lg font-semibold text-blue-400 mb-3">Adoption Metrics</h4>
                                    <div className="space-y-2 text-sm">
                                        <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-between">
                                            <span>Traditional Reach:</span>
                                            <span className="text-yellow-400">{analyticsData.platformMetrics.shopSales} customers</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>Philosophy Spread:</span>
                                            <span className="text-purple-400">{analyticsData.platformMetrics.webVisitors} visitors</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
