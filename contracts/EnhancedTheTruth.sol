...
contract EnhancedTheTruth is ERC721, ERC721Enumerable, ERC721Pausable, ERC2981, Ownable, AccessControl, ReentrancyGuard, PullPayment {
    ...
    ) ERC721("The Truth Enhanced", "TRUTHX") Ownable(initialOwner) ERC721Pausable() ERC2981(_setRoyalty) {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721, ERC721Enumerable, ERC721Pausable, ERC2981, AccessControl)
        returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }

    // Royalty function override for ERC2981
    function _setRoyalty(uint256 tokenId, address receiver, uint96 feeNumerator)
        internal
        override(ERC2981)
    {
        require(feeNumerator <= 1000, "Royalty fee too high"); // Max 10%
        super._setRoyalty(tokenId, receiver, feeNumerator);
    }
}